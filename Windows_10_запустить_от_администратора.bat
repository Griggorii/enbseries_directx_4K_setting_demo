...
Title Windows 10 ENBSeries 0.308 compatibility script %scriptversion%

echo.
echo  .:[ Windows 10 ENBSeries 0.308 startup utility %scriptversion% ]:.

REM Gets the SID of the current logged in user, needed for wiping the registry values which cause issues with ENB 0.308
